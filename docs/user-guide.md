...
footer names who is invited, for example **Invite Mo Kai**. A click on an invite
or travel row only selects it; press Enter, click the footer action, or
double-click the row to send it. Guild Wars answers
the invite in chat.
