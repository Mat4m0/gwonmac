...
them — `scripts/enhancements-live/scenarios.mjs` for the paired live benchmark and
`scripts/enhancements-live/acceptance.mjs` for the common gates — so read a figure
