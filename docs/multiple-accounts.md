...
reveals the launcher. A Dock activation or second app launch restores and
focuses the launcher. An asynchronous Play completion does not steal focus if
the player has already moved to another app.
