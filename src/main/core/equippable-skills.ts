// Guild Wars' skill table contains far more than skills a character can put
// on a bar: NPC attacks, item effects, weapon modifiers, unused records, and
// PvP replacements all share the same table. `Skill::IsPlayable()` alone does
// not separate those records.
//
// This 2240-bit allowlist is the audited set GWToolbox++ generated from the
// game's account-unlocked skill array. It is copied under the MIT grant in
// `src/native/skill-icons/vendor/COPYING-GWTOOLBOX`, which is also included in
// packaged Resources. Keeping the exact bitset here makes it the one
