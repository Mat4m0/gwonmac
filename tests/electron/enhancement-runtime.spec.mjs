...
import {
  prepareClientModule,
} from "../../build/main/core/client-module.js";
import { gamePaths } from "../../build/main/core/paths.js";
import { loadSettings } from "../../build/main/core/settings.js";
import { ENHANCEMENT_BUILDS } from "../../build/main/core/enhancement-builds.js";
import {
  closeOffline,
  launchOffline,
  main,
...
test.describe("Enhancement runtime selection", () => {
  ...
  test("all tools off removes the cache and selects an unmodified module", async () => {
    ...
    try {
      const init = await fixture.page.evaluate(() => globalThis.gwNative.init);
      expect(init).toEqual({
