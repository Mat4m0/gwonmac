...
function session(capabilities: EnhancementCapabilities): ClientSession {
  ...
  const compatibility: ClientCompatibility = {
    ...
    features: {
      ...
      alcoholObservation: selected(capabilities.alcoholObservation),
      nativeHudRendering: selected(capabilities.nativeHudRendering),
      resignAction: selected(capabilities.resignAction),
      whisperChat: selected(capabilities.whisperChat),
    ...
    const value: ClientSession = {
      ...
      compatibility: {
        ...
        features: {
          ...
          alcoholObservation: off,
          nativeHudRendering: off,
          resignAction: off,
          whisperChat: off,
