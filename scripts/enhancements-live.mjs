...
} from "../build/tools/enhancement-doctor.js";
import {
  parseEnhancementObservations,
} from "../build/tools/enhancement-observations.js";
import {
  liveRunPlan,
  liveRunRefusal,
  scenarioContext,
  waitForPlayable,
} from "./enhancements-live/scenarios.mjs";
import {
  validateCommonAcceptance,
} from "./enhancements-live/acceptance.mjs";
import { projectLiveResult } from "./enhancements-live/result.mjs";

/** @typedef {import("playwright").Browser} Browser */
/** @typedef {import("playwright").Page} Page */
/** @typedef {import("../build/shared/automation.js").AutomationCommand} AutomationCommand */
/**
 * @typedef {import("./enhancements-live/scenarios.mjs").ObservationSample}
 *   ObservationSample
 */
