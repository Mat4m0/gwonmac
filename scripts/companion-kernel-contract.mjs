...
export const COMPANION_KERNEL_DYLINK0 = Object.freeze([
  // Memory footprint 2205 bytes (0x9d 0x11 as LEB128). Documented moves:
  ...
  //   2201 -> 2205 the certified travel-unlock layout word extends Layout;
  //                the 28-word publication lives in host-owned snapshot memory.
  ...
  // under it.
  0x01, 0x05, 0x9d, 0x11, 0x02, 0x00, 0x00,
]);
