 ...
 * only part common acceptance is allowed to judge. `scripts/enhancements-live.mjs`
 ...
 * @property {boolean} supported whether the Enhancement runtime installed at all.
