...
/** @typedef {import("../../build/tools/enhancement-doctor.js").EnhancementDoctorReport} EnhancementDoctorReport */
/**
 * @typedef {import("../../build/tools/enhancement-observations.js").EnhancementObservationType}
