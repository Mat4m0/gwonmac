...
| `UR-10` | Raise the maximum heap size | 3 | Low | Medium |
...
information, or hits a small defect. Priority 3: nothing is lost today, but the
platform improves.
...
`UR-07` to `UR-09`
:::
:::card{title="Runtime" description="One build flag for long play sessions." icon="lucide:cpu" to="$docs/upstream/runtime/heap-maximum"}
`UR-10`
:::
